...
def conectar():
    ...
    try:
        ...
        print(f'Erro na conexao na conexao mysql server {error}')
...
def listar():
    ...
    if len(produtos) != 0:
        ...
        for produto in produtos:
            ...
            print(f'QNT EM ESTOQUE: {produto[3]}')
            print('====================')
    else:
...
def atualizar():
    ...
    preco = float(input('Informa o novo preco do produto: '))
    ...
    if cursor.rowcount == 1:
        ...
        print(f'Erro ao atualizado o produto.')
